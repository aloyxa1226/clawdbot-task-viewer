...
○ clawdbot-task-viewer-apz · [US-005 FE] Display Task Details and Files in UI   [● P1 · OPEN]
Owner: admin · Type: task
Created: 2026-01-27 · Updated: 2026-01-27

DESCRIPTION
Display detailed information about each task, including file attachments, in a detail panel.

ACCEPTANCE CRITERIA
Clicking on a task opens a detail panel. The detail panel displays the task subject, description, status, and dependencies. File attachments are listed with their names and content types. Verify in browser. Typecheck passes

DEPENDS ON
  → ✓ clawdbot-task-viewer-68o: [US-005 BE] Implement API to serve file attachments ● P1
```
...
- Working directory: /Users/admin/clawd/clawdbot-task-viewer/.worktrees/clawdbot-task-viewer-apz
- Branch: bead/clawdbot-task-viewer-apz
- Bead ID: clawdbot-task-viewer-apz
