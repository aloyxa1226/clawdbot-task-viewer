...
○ clawdbot-task-viewer-lxf · [US-007] Implement Ngrok Tunnel   [● P0 · OPEN]
Owner: admin · Type: task
Created: 2026-01-27 · Updated: 2026-01-27

DESCRIPTION
Implement automatic public URL generation using Ngrok.

ACCEPTANCE CRITERIA
On startup, the application creates an Ngrok tunnel. The public URL is displayed in the console output. The application remains accessible via the Ngrok URL. Typecheck passes

DEPENDS ON
  → ✓ clawdbot-task-viewer-dzj: [US-006] Create Docker Compose file ● P0
```
...
- Working directory: /Users/admin/clawd/clawdbot-task-viewer/.worktrees/clawdbot-task-viewer-lxf
- Branch: bead/clawdbot-task-viewer-lxf
- Bead ID: clawdbot-task-viewer-lxf
